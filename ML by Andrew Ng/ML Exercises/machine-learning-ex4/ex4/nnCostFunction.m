...
% Cost function of unregularized logistic regression:
% h = sigmoid(X*theta);
...
% Recode labels of y as vectors containing only 0 or 1
Y = eye(num_labels);
y = Y(y,:); % 5000*10 matrix

% Add ones vector to X, then transpose Theta1
a1 = [ones(m,1) X]; % 5000*401 matrix

% Add ones vector to X1, then transpose Theta2
z2 = a1*Theta1'; % 5000*25
a2 = [ones(m,1) sigmoid(z2)]; % 5000*26
a3 = sigmoid(a2*Theta2'); % 5000*10 matrix
